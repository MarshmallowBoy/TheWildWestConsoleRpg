...
namespace TextBasedRpg
{
    class Program
    {
        static void Main()
        {
            ...
            Console.WriteLine("5 - I Made This Difficulty So My Friend Doesn't Get To 300 Days Because If He Does Then I Will Have To Play Pony Town With Him - 40 lbs/day");
